...
def plot_icncProfiles_split(obs_data,twcvar,twcstr, thresholding, plots_out_dir,dates,prof_time, **args): #, lon, lat):
    ...
    print ('******')
    print ('')
    print ('Plotting ICNC mean profiles split times:' + twcvar)
    print ('')
